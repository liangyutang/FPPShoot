...
void UTP_WeaponComponent::ClientFire_Implementation()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			ActorSpawnParams.Instigator=UGameplayStatics::GetPlayerPawn(this,1);
...
bool UTP_WeaponComponent::ClientFire_Validate()
{
	return true;
}
